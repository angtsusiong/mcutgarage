        ...
        $('.users_table').each(function(){
            ...
            var editor = new $.fn.dataTable.Editor({
                ...
                },
                {
                    fieldInfo: '',
                    label: 'self_intro',
                    label: I18n.t('activerecord.attributes.user.self_intro'),
                    name: 'self_intro',
                },
                {
                    fieldInfo: '',
            ...
            var datatable = table.DataTable({
                ...
                },
                {
                    ...
                    visible: true,
                    orderable: false,
                    className: 'editable col-phone',
                    editField: 'phone',
                },
                {
                    data: 'self_intro',
                    name: 'self_intro_cont',
                    visible: true,
                    orderable: false,
                    className: 'editable col-self_intro',
                    editField: 'self_intro',
                },
                {
                    data: 'name',
                    name: 'name_cont',
                ...
                },
                    {
                        ...
                        render: function ( data, type, full, meta ) {
                            var id = data.id;
                            var actions = '<a href="/users/' + id + '?master_show_tab='+ master_show_tab +'" class="btn btn-default m-r-10"><span class="fa fa-eye fa-lg"></span></a>';
                            actions += '<a href="/users/' + id + '/edit?master_show_tab='+ master_show_tab +'" class="btn btn-default m-r-10"><span class="fa fa-pencil fa-lg"></span></a>';
                            actions += '<a href="/users/' + id + '" data-confirm="確定刪除?" class="btn btn-default" rel="nofollow" data-method="delete"><span class="fa fa-trash fa-lg"></span></a>';
                            return actions;
                        },
                    },
                ],

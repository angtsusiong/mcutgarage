...
(function() {
    ...
    this.initialize = function() {
        ...
        if( typeof version_id !== 'undefined' && version_id != "" && typeof master_show_tab !== 'undefined' && master_show_tab != "" ) {
            $.ajax({
                url: "/admin/versions/"+ version_id +"/render_tab_content",
                method: 'get',
                dataType: 'html',

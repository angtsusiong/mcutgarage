var admin_versions = admin_versions || {};
$.extend(true, admin_versions, { 
	datatables: {}
});
...
(function() {
    ...
    this.datatables.initialize = function() {
        ...
        // 列表頁的 datatables 設定
        $('.versions_table').each(function(){
            var table = $(this);
            var tab_key = table.data('tab_key');

            var editor = new $.fn.dataTable.Editor({
                ajax: {
                    url: '/admin/versions/update_row',
                    type: 'PATCH'
                },
                table: "#"+ tab_key +"_versions_table",
                idSrc: "DT_RowId",
                fields: [
                    {
                    fieldInfo: '',
                    label: 'item_type',
                    label: I18n.t('activerecord.attributes.version.item_type'),
                    name: 'item_type',
                },
                {
                    fieldInfo: '',
                    label: 'item_id',
                    label: I18n.t('activerecord.attributes.version.item_id'),
                    name: 'item_id',
                },
                {
                    fieldInfo: '',
                    label: 'event',
                    label: I18n.t('activerecord.attributes.version.event'),
                    name: 'event',
                },
                {
                    fieldInfo: '',
                    label: 'whodunnit',
                    label: I18n.t('activerecord.attributes.version.whodunnit'),
                    name: 'whodunnit',
                },
                {
                    fieldInfo: '',
                    label: 'object',
                    label: I18n.t('activerecord.attributes.version.object'),
                    name: 'object',
                },
                {
                    fieldInfo: '',
                    label: 'object_changes',
                    label: I18n.t('activerecord.attributes.version.object_changes'),
                    name: 'object_changes',
                },
                ],
            });
            ...
            var datatable = table.DataTable({
                ...
                dom: 'Brtip"bottom"l',
                ajax: {
                    url: '/admin/versions/datatables.json',
                    dataSrc: 'data',
                    type: 'POST',
                    data: {
                    },
                ...
                columns:[
                    ...
                    visible: true,
                    orderable: false,
                    className: 'editable col-item_type',
                    editField: 'item_type',
                },
                {
                    data: 'item_id',
                    name: 'item_id_between',
                    visible: true,
                    orderable: false,
                    className: 'editable col-item_id',
                    editField: 'item_id',
                },
                {
                    data: 'event',
                ...
                },
                {
                    ...
                    visible: true,
                    orderable: false,
                    className: 'editable col-whodunnit',
                    editField: 'whodunnit',
                },
                {
                    data: 'object',
                    ...
                    visible: true,
                    orderable: false,
                    className: 'editable col-object',
                    editField: 'object',
                },
                {
                    data: 'object_changes',
                    name: 'object_changes_cont',
                    visible: true,
                    orderable: false,
                    className: 'editable col-object_changes',
                    editField: 'object_changes',
                },
                    {
                        // 操作
                        data: null,
                        ...
                        render: function ( data, type, full, meta ) {
                            var id = data.id;
                            var actions = '<a href="/admin/versions/' + id + '?master_show_tab='+ master_show_tab +'" class="btn btn-default m-r-10"><span class="fa fa-eye fa-lg"></span></a>';
                            actions += '<a href="/admin/versions/' + id + '/edit?master_show_tab='+ master_show_tab +'" class="btn btn-default m-r-10"><span class="fa fa-pencil fa-lg"></span></a>';
                            actions += '<a href="/admin/versions/' + id + '" data-confirm="確定刪除?" class="btn btn-default" rel="nofollow" data-method="delete"><span class="fa fa-trash fa-lg"></span></a>';
                            return actions;
                        },
                    },
                ],
            ...
            $("#"+ tab_key +"_versions_table").on( 'click', 'tbody td.editable', function (e) {
        ...
        // 點擊頁籤
        $('.version__tab').on('click', function(){
            var tab = $(this);
...
}).apply(admin_versions);

$(function() {
    admin_versions.datatables.initialize();
});

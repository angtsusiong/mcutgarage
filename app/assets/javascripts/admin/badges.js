...
(function() {
    ...
    this.initialize = function() {
        ...
        if( typeof badge_id !== 'undefined' && badge_id != "" && typeof master_show_tab !== 'undefined' && master_show_tab != "" ) {
            $.ajax({
                url: "/admin/badges/"+ badge_id +"/render_tab_content",
                method: 'get',
                dataType: 'html',

...
(function() {
    ...
    this.initialize = function() {
        ...
        if( typeof step_id !== 'undefined' && step_id != "" && typeof master_show_tab !== 'undefined' && master_show_tab != "" ) {
            $.ajax({
                url: "/admin/steps/"+ step_id +"/render_tab_content",
                method: 'get',
                dataType: 'html',

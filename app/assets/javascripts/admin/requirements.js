...
(function() {
    ...
    this.initialize = function() {
        ...
        if( typeof requirement_id !== 'undefined' && requirement_id != "" && typeof master_show_tab !== 'undefined' && master_show_tab != "" ) {
            $.ajax({
                url: "/admin/requirements/"+ requirement_id +"/render_tab_content",
                method: 'get',
                dataType: 'html',
